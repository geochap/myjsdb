...
var Store = exports.Store = function(name, options){
    ...
    this.endTransaction = function(commit, fn){
        var query = commit?'commit transaction':'rollback transaction';

        this.client.query(query, fn);
    }
...
var Query = function(options){
    ...
    var getColumn = function(pv, constraint){
        if ((constraint != null && typeof constraint.arg2 == 'string') || pv.value == String)
            return ".string_value";
        if ((constraint != null && typeof constraint.arg2 == 'number') || pv.value == Number)
            return ".number_value";
        if ((constraint != null && typeof constraint.arg2 == "boolean") || pv.value == Boolean)
            return ".bool_value";
